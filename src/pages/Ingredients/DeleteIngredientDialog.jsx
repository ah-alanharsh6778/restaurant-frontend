    ...
    >
      ...
      <DialogContent>
        <DialogContentText color="text.secondary">
          Are you sure you want to delete <strong>{ingredient?.name || 'this ingredient'}</strong>? This action cannot be undone and will permanently remove this record from your backend database.
        </DialogContentText>
      </DialogContent>
