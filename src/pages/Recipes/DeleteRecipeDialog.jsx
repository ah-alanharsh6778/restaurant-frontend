    ...
    >
      ...
      <DialogContent>
        <DialogContentText color="text.secondary">
          Are you sure you want to delete recipe <strong>{recipe?.name || 'this recipe'}</strong>? This action will permanently remove the recipe specification and all associated ingredient mappings.
        </DialogContentText>
      </DialogContent>
